...
new cdktn.CdktnConfig(project: Project, options: CdktnConfigOptions)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.cdktn.CdktnConfig.Initializer.parameter.project">project</a></code> | <code>projen.Project</code> | *No description.* |
...
##### `project`<sup>Required</sup> <a name="project" id="projen.cdktn.CdktnConfig.Initializer.parameter.project"></a>
...
| <code><a href="#projen.cdktn.CdktnConfig.property.json">json</a></code> | <code>projen.JsonFile</code> | Represents the JSON file. |
...
##### `json`<sup>Required</sup> <a name="json" id="projen.cdktn.CdktnConfig.property.json"></a>
...
### CdktnDepsJs <a name="CdktnDepsJs" id="projen.cdktn.CdktnDepsJs"></a>

Manages dependencies on CDK Terrain (CDKTN) for Node.js projects.

#### Initializers <a name="Initializers" id="projen.cdktn.CdktnDepsJs.Initializer"></a>

```typescript
import { cdktn } from 'projen'

new cdktn.CdktnDepsJs(project: Project, options: CdktnDepsOptions)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.cdktn.CdktnDepsJs.Initializer.parameter.project">project</a></code> | <code>projen.Project</code> | *No description.* |
| <code><a href="#projen.cdktn.CdktnDepsJs.Initializer.parameter.options">options</a></code> | <code><a href="#projen.cdktn.CdktnDepsOptions">CdktnDepsOptions</a></code> | *No description.* |

---

##### `project`<sup>Required</sup> <a name="project" id="projen.cdktn.CdktnDepsJs.Initializer.parameter.project"></a>

- *Type:* projen.Project

---

##### `options`<sup>Required</sup> <a name="options" id="projen.cdktn.CdktnDepsJs.Initializer.parameter.options"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#projen.cdktn.CdktnDepsJs.toString">toString</a></code> | Returns a string representation of this construct. |
| <code><a href="#projen.cdktn.CdktnDepsJs.with">with</a></code> | Applies one or more mixins to this construct. |
| <code><a href="#projen.cdktn.CdktnDepsJs.postProjectCreation">postProjectCreation</a></code> | Called once, right after `postSynthesize()`, only when the project is created for the first time. |
| <code><a href="#projen.cdktn.CdktnDepsJs.postSynthesize">postSynthesize</a></code> | Called after synthesis. |
| <code><a href="#projen.cdktn.CdktnDepsJs.preSynthesize">preSynthesize</a></code> | Called before synthesis. |
| <code><a href="#projen.cdktn.CdktnDepsJs.projectCreation">projectCreation</a></code> | Called once, right after `synthesize()`, only when the project is created for the first time. |
| <code><a href="#projen.cdktn.CdktnDepsJs.synthesize">synthesize</a></code> | Synthesizes files to the project output directory. |

---

##### `toString` <a name="toString" id="projen.cdktn.CdktnDepsJs.toString"></a>
...
##### `with` <a name="with" id="projen.cdktn.CdktnDepsJs.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="projen.cdktn.CdktnDepsJs.with.parameter.mixins"></a>
...
##### `postProjectCreation` <a name="postProjectCreation" id="projen.cdktn.CdktnDepsJs.postProjectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="projen.cdktn.CdktnDepsJs.postProjectCreation.parameter.initProject"></a>
...
##### `postSynthesize` <a name="postSynthesize" id="projen.cdktn.CdktnDepsJs.postSynthesize"></a>
...
##### `preSynthesize` <a name="preSynthesize" id="projen.cdktn.CdktnDepsJs.preSynthesize"></a>
...
##### `projectCreation` <a name="projectCreation" id="projen.cdktn.CdktnDepsJs.projectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="projen.cdktn.CdktnDepsJs.projectCreation.parameter.initProject"></a>
...
##### `synthesize` <a name="synthesize" id="projen.cdktn.CdktnDepsJs.synthesize"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#projen.cdktn.CdktnDepsJs.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |
| <code><a href="#projen.cdktn.CdktnDepsJs.isComponent">isComponent</a></code> | Test whether the given construct is a component. |

---

##### `isConstruct` <a name="isConstruct" id="projen.cdktn.CdktnDepsJs.isConstruct"></a>

```typescript
import { cdktn } from 'projen'

cdktn.CdktnDepsJs.isConstruct(x: any)
```
...
###### `x`<sup>Required</sup> <a name="x" id="projen.cdktn.CdktnDepsJs.isConstruct.parameter.x"></a>
...
##### `isComponent` <a name="isComponent" id="projen.cdktn.CdktnDepsJs.isComponent"></a>

```typescript
import { cdktn } from 'projen'

cdktn.CdktnDepsJs.isComponent(x: any)
```

Test whether the given construct is a component.

###### `x`<sup>Required</sup> <a name="x" id="projen.cdktn.CdktnDepsJs.isComponent.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.cdktn.CdktnDepsJs.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#projen.cdktn.CdktnDepsJs.property.project">project</a></code> | <code>projen.Project</code> | *No description.* |
| <code><a href="#projen.cdktn.CdktnDepsJs.property.cdktnCliVersion">cdktnCliVersion</a></code> | <code>string</code> | The dependency requirement for the CDKTN CLI. |
| <code><a href="#projen.cdktn.CdktnDepsJs.property.cdktnMinimumVersion">cdktnMinimumVersion</a></code> | <code>string</code> | The minimum version of CDKTN (e.g. `0.24.0`). |
| <code><a href="#projen.cdktn.CdktnDepsJs.property.cdktnVersion">cdktnVersion</a></code> | <code>string</code> | The dependency requirement for CDKTN (e.g. `^0.24.0`). |

---

##### `node`<sup>Required</sup> <a name="node" id="projen.cdktn.CdktnDepsJs.property.node"></a>
...
##### `project`<sup>Required</sup> <a name="project" id="projen.cdktn.CdktnDepsJs.property.project"></a>
...
##### `cdktnCliVersion`<sup>Required</sup> <a name="cdktnCliVersion" id="projen.cdktn.CdktnDepsJs.property.cdktnCliVersion"></a>
...
##### `cdktnMinimumVersion`<sup>Required</sup> <a name="cdktnMinimumVersion" id="projen.cdktn.CdktnDepsJs.property.cdktnMinimumVersion"></a>
...
##### `cdktnVersion`<sup>Required</sup> <a name="cdktnVersion" id="projen.cdktn.CdktnDepsJs.property.cdktnVersion"></a>
...
### CdktnPackageNames <a name="CdktnPackageNames" id="projen.cdktn.CdktnPackageNames"></a>

Language-specific CDKTN package names.

#### Initializer <a name="Initializer" id="projen.cdktn.CdktnPackageNames.Initializer"></a>

```typescript
import { cdktn } from 'projen'

const cdktnPackageNames: cdktn.CdktnPackageNames = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#projen.cdktn.CdktnPackageNames.property.constructs">constructs</a></code> | <code>string</code> | Fully qualified name of the constructs library package. |
| <code><a href="#projen.cdktn.CdktnPackageNames.property.core">core</a></code> | <code>string</code> | Fully qualified name of the core CDKTN framework package. |

---

##### `constructs`<sup>Required</sup> <a name="constructs" id="projen.cdktn.CdktnPackageNames.property.constructs"></a>
...
##### `core`<sup>Required</sup> <a name="core" id="projen.cdktn.CdktnPackageNames.property.core"></a>
